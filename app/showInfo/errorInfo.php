...
<div class="error_new_bg pr">
	<div class="error_new_content">
		<div class="error_new pa">
			<div class="fl error_new_left"><img src="http://localhost/web_com/public/image/error.png"></div>
			<div class="fl error_new_right">
				<div class="error_detail">
					<p class="error_p_title">Error Dialog</p>
					<p class="error_p_title">[ErrorInfo]</p>
					<p class="error_p_con">※ You can contact the person in charge Gang Han WeChat:123456</p>
					<p class="error_p_con">※ 您可以联系小清新框架负责人 韩刚 微信:123456</p>
